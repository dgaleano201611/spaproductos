  ...
  return (
    <Form onSubmit={enviarFormulario}>
        ...
        <Form.Group className="mb-3" controlId="imagen">
            ...
            <Form.Control type="text" placeholder="Ingrese la imagen" required
                value={imagen} onChange={e=>setImagen(e.target.value)}/>
        </Form.Group>

        <Form.Group className="mb-3" controlId="precio">
            <Form.Label>Precio</Form.Label>
            <Form.Control type="text" placeholder="Ingrese el precio" required
        ...
        <Form.Group className="mb-3" controlId="descripcion">
            ...
            <Form.Control type="text" placeholder="Ingrese la descripcion" required
